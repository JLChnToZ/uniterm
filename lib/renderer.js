...
const tabContainer = rootContainer.appendChild(h("div", { className: "ts top attached mini tabbed menu" }));
const addButton = tabContainer.appendChild(h("a", { className: "item", onclick: async () => {
