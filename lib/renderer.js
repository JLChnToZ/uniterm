...
lazy_decorator_1.lazyProperty.require(require, './remote-wrapper', 'electron', window);
lazy_decorator_1.lazyProperty.require(require, './terminals/base', 'TerminalBase', window);
lazy_decorator_1.lazyProperty.require(require, './terminals/pty', 'PtyShell', window);
lazy_decorator_1.lazyProperty.require(require, './terminals/wslpty', 'WslPtyShell', window);
lazy_decorator_1.lazyProperty.require(require, './terminals/uacwrapper', 'UACClient', window);
