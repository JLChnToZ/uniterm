...
const advanced_open_1 = require("./advanced-open");
...
const header = layoutContainer.appendChild(hyperscript_1.default("div", { className: "header pty-tabs" },
    ...
    hyperscript_1.default("a", { className: "icon item", onclick: search_1.toggleSearch, title: "Search" }, '\uf848'),
...
const colorRuleNormal = dynamicStyle.cssRules[dynamicStyle.insertRule('html, body {}')].style;
...
if (document.readyState !== 'complete')
    ...
    electron_1.ipcRenderer.send('ready');
config_1.startWatch();
advanced_open_1.init(createTab);
