...
class Tab {
    constructor(pause) {
        ...
        this.tabContent = h("div", { ondragenter: this.handleDragEnter.bind(this), ondragover: interceptEvent, ondrop: this.handleDrop.bind(this) });
    ...
    async attach(pty) {
        ...
        this.pty = pty;
        this.disposables.push(this.terminal.addDisposableListener('data', this.handleDataInput.bind(this)), this.terminal.addDisposableListener('resize', ({ cols, rows }) => this.pty.resize(cols, rows)), this.terminal.addDisposableListener('title', this.handleTitleChange.bind(this)), attachDisposable(pty, 'data', this.handleDataOutput.bind(this)), attachDisposable(pty, 'end', this.pause ?
