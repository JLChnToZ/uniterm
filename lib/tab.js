...
function onFirstTabCreated(terminal) {
    try {
        ...
        electron_1.remote.getCurrentWindow().setSize(window.outerWidth - parseInt(elementStyle.getPropertyValue('width'), 10) + actualCellWidth * 80, window.outerHeight - parseInt(elementStyle.getPropertyValue('height'), 10) + actualCellHeight * 25);
    }
    catch (e) {
        console.error(e);
    }
