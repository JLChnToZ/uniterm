...
exports.init = exports.toggleOpen = void 0;
...
const launchBar = document.body.appendChild(hyperscript_1.default("div", { className: "toolbar hidden" },
    hyperscript_1.default("div", { className: "inner" },
        ...
        launch = hyperscript_1.default("input", { type: "text", className: "open input", placeholder: default_shell_1.default, onkeydown: e => {
                switch (e.which) {
                    default: return;
                    case 27: /* Escape */
                        toggleOpen();
