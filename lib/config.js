...
exports.configFilePath = path_1.resolve(getApp().getPath('userData'), 'uniterm.yml');
function getApp() {
    switch (process.type) {
        case 'renderer':
            return electron_1.remote.app;
        default:
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, readFileAsync(path_1.resolve(__dirname, '../static/config.default.yml'), 'utf-8')];
                case 2:
                    configFileRaw = _a.sent();
                    return [4 /*yield*/, writeFileAsync(exports.configFilePath, configFileRaw, 'utf-8')];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 6];
                case 4: return [4 /*yield*/, readFileAsync(exports.configFilePath, 'utf-8')];
                case 5:
                    configFileRaw = _a.sent();
                    _a.label = 6;
                case 6:
