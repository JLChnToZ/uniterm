...
function handleAppProtocol(request) {
    ...
    if (url.startsWith('/userdata/'))
        return path_1.resolve(electron_1.app.getPath('userData'), url.substr(10));
    if (url.startsWith('/node_modules/'))
        return path_1.resolve(rootPath, url.substr(1));
    return path_1.resolve(staticPath, url.substr(1) || 'index.html');
}
