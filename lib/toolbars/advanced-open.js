...
class AdvancedOpen extends base_1.Toolbar {
    ...
    render() {
        return [
            ...
            this.launch = hyperscript_1.default("input", { type: "text", className: "open input", placeholder: default_shell_1.default, spellcheck: false, onkeydown: e => {
                    switch (e.which) {
                        default: return;
                        case 27: /* Escape */
                            this.hide();
            ...
            hyperscript_1.default("a", { className: "icon item", title: "Pause on Exit", onclick: e => this.pause = e.target.classList.toggle('active') }, '\uf8e7'),
            hyperscript_1.default("a", { className: "icon item", title: "Launch in New Tab", onclick: () => this.doLaunch(false) }, '\ufc5a'),
            hyperscript_1.default("a", { className: "icon item", title: "Launch in New Window", onclick: () => this.doLaunch(true) }, '\uf465'),
        ];
    }
    async selectCWD() {
