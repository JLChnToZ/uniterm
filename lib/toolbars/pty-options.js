...
class PtyOptionsToolbar extends base_1.Toolbar {
    ...
    render() {
        ...
        this.pause = hyperscript_1.default("a", { className: "icon item", title: "Pause on Exit", onclick: e => {
                const tab = tab_1.Tab.activeTab;
        ...
        return [
            ...
            hyperscript_1.default("a", { className: "icon item", title: "Clear Console", onclick: e => this.clear(e.shiftKey) }, '\uf89e'),
            hyperscript_1.default("a", { className: "icon item", title: "Disable Input", onclick: e => {
                    const tab = tab_1.Tab.activeTab;
                    e.target.textContent = (!tab || !(tab.acceptInput = !tab.acceptInput)) ? '\uf80f' : '\uf80b';
                } }, '\uf80b'),
            this.pause,
        ];
    }
    ...
    clear(reset) {
        var _a;
        const terminal = (_a = tab_1.Tab.activeTab) === null || _a === void 0 ? void 0 : _a.terminal;
        if (terminal) {
            if (reset)
                terminal.reset();
            else
