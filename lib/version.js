...
const packageJson = JSON.parse(fs_1.readFileSync(path_1.resolve(rootPath, 'package.json'), 'utf-8'));
exports.versionString = `${packageJson.name} v${packageJson.version}\n` +
...
default_context_menu_1.defaultContextMenuTemplate.push({ type: 'separator' }, { role: 'about', click: showAbout });
