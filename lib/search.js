...
const searchBar = document.body.appendChild(hyperscript_1.default("div", { className: "toolbar hidden" },
    hyperscript_1.default("div", { className: "inner" },
        search = hyperscript_1.default("input", { type: "search", className: "search input", placeholder: "Search", oninput: () => {
                doSearch(true);
            }, onkeydown: e => {
                switch (e.which) {
                    default: return;
        ...
        hyperscript_1.default("a", { className: "icon item", title: "Hide", onclick: toggleSearch }, '\uf85f'))));
